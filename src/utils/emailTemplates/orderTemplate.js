const orderTemplate = ({ name="User", orderId, date }) => {
  return `
  <div style="font-family: Arial, sans-serif; background:#f5f5f5; padding:20px;">
    ...
    <div style="max-width:600px; margin:auto; background:#fff; border-radius:8px; overflow:hidden;">
      ...
      <div style="padding:20px;">
        ...
        <p>Great news! Your order has been <strong>created</strong> 🎉</p>

        <div style="background:#f1f5f9; padding:15px; border-radius:6px; margin:15px 0;">
          <p><strong>Order ID:</strong> ${orderId}</p>
          <p><strong>Created On:</strong> ${new Date(date).toLocaleDateString()}</p>
        </div>
